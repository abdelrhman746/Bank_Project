...
public:
	...
	enum enPermissions {
		eAll = -1, pListClients = 1, pAddNewClient = 2, pDeleteClients = 4,
	...
	{
		fstream MyFile;
		MyFile.open("Users.txt", ios::in);//read
	...
	enum enSaveResults { svFaildEmptyObject = 0, svSucceeded = 1, svFailUserExists = 2 };
